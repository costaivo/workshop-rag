...
**Example:** [`data/workshop_speakers.txt`](https://github.com/costaivo/workshop-rag/blob/main/lab-01/data/workshop_speakers.txt) — a multi-day workshop speakers with schedule:
```text
📅 4‑Day Workshop Schedule 
